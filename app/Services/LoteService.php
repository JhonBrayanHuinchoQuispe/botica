...
class LoteService
{
    ...
    public function crearLote(array $datos): ProductoUbicacion
    {
        return DB::transaction(function () use ($datos) {
            ...
            $lote = ProductoUbicacion::create([
                ...
                'lote' => $datos['lote'],
                'precio_compra_lote' => $datos['precio_compra'] ?? null,
                'precio_venta_lote' => $datos['precio_venta'] ?? null,
    ...
    {
        $stockEnLotes = ProductoUbicacion::where('producto_id', $productoId)
            ->where('estado_lote', 'activo')
            ->sum('cantidad');
