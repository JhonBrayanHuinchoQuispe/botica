...
class PresentacionController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'unidad_venta' => 'nullable|string|max:50',
            'factor_unidad_base' => 'nullable|integer|min:1',
        ...
        try {
            ...
            $presentacion->unidad_venta = $request->unidad_venta;
            $presentacion->factor_unidad_base = $request->factor_unidad_base ?? 1;
            $presentacion->precio_venta = $request->precio_venta;
            $presentacion->permite_fraccionamiento = (bool)$request->permite_fraccionamiento;
            $presentacion->save();
