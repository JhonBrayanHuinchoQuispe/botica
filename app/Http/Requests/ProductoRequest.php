...
class ProductoRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            // Mensajes para campos de lote profesional
            ...
            'fabricante.max' => 'El fabricante no puede exceder 255 caracteres.',
            'pais_origen.max' => 'El país de origen no puede exceder 100 caracteres.',
            'observaciones_lote.max' => 'Las observaciones del lote no pueden exceder 500 caracteres.',
            ...
            'cantidad_inicial.max' => 'La cantidad inicial no puede exceder 999,999.',
