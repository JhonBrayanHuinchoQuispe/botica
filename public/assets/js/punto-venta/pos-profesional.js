...
class POSProfesional {
    ...
    crearTarjetaProducto(producto) {
        ...
        const imagenUrl = this.normalizarImagen(producto.imagen) || '/assets/images/default-product.png';
        ...
        card.innerHTML = `
            <div class="producto-imagen">
                <img src="${imagenUrl}" alt="${producto.nombre}" loading="lazy" class="producto-imagen-img lazy" onload="this.classList.remove('lazy')" onerror="this.src='/assets/images/default-product.png'">
        ...
        try {
            ...
            const response = await fetch('/api/whatsapp/enviar-boleta', {
                ...
                body: JSON.stringify({
                    venta_id: venta.id,
                    telefono: telefono,
                    tipo_comprobante: (document.getElementById('whatsapp-formato')?.value) || 'boleta_a4',
