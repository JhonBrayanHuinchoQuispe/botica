...
function buscarVenta() {
    ...
    // Mostrar loading
    Swal.fire({
        title: 'Buscando venta...',
        text: 'Por favor espera mientras se busca la venta',
...
function mostrarConfirmacionDevolucion(productos) {
    ...
    Swal.fire({
        ...
        confirmButtonText: '<i class="material-icons" style="margin-right: 0.5rem;">check_circle</i>Sí, procesar',
        cancelButtonText: '<i class="material-icons" style="margin-right: 0.5rem;">cancel</i>No',
        buttonsStyling: true,
        customClass: {
...
function enviarDevolucion(productos) {
    ...
    Swal.fire({
        ...
        text: 'Por favor espera mientras se procesa la devolución',
        allowOutsideClick: false,
        showConfirmButton: false,
        willOpen: () => {
            Swal.showLoading();
