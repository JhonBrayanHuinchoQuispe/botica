...
use App\Http\Controllers\Inventario\PresentacionController;
...
Route::middleware('auth')->group(function () {
    ...
    // ============================================
    // MÓDULO DE INVENTARIO - SIN MIDDLEWARES TEMPORALMENTE
    // ============================================
    
    // Inventario - todas las rutas sin middlewares
    ...
    Route::prefix('inventario/categoria/api')->group(function () {
        ...
        Route::get('/all', function() {
            return response()->json(['success' => true, 'data' => \App\Models\Categoria::orderBy('nombre')->get(['id','nombre'])]);
        });
    ...
    Route::prefix('inventario/presentacion/api')->group(function () {
        ...
        Route::get('/all', function() {
            return response()->json(['success' => true, 'data' => \App\Models\Presentacion::orderBy('nombre')->get(['id','nombre'])]);
        });
    ...
    Route::prefix('lotes')->name('lotes.')->group(function () {
        Route::controller(\App\Http\Controllers\VentaLoteController::class)->group(function () {
            Route::post('/procesar-venta', 'procesarVenta')->name('procesar-venta');
