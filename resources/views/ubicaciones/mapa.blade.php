    ...
    <div class="card-body">
        ...
        <div class="tabs-container-modern">
            <div class="tabs-wrapper">
                <button class="tab-link-modern active" data-tab="tab-mapa">
                    <div class="tab-icon">
                        <iconify-icon icon="solar:map-bold-duotone"></iconify-icon>
                    </div>
                    <span class="tab-text">Mapa del Almacén</span>
                </button>
                <button class="tab-link-modern" data-tab="tab-listado-ubicados">
                    <div class="tab-icon">
                        <iconify-icon icon="solar:checklist-bold-duotone"></iconify-icon>
                    </div>
                    <span class="tab-text">Productos Ubicados</span>
                </button>
                <button class="tab-link-modern" data-tab="tab-listado-sin-ubicar">
                    <div class="tab-icon">
                        <iconify-icon icon="solar:question-circle-bold-duotone"></iconify-icon>
                    </div>
                    <span class="tab-text">Productos sin Ubicar</span>
                </button>
            </div>
        </div>
        ...
        <div id="tab-mapa" class="tab-content-modern">
            ...
            <div class="warehouse-section-modern">
                ...
                <div class="warehouse-container-modern">
                    ...
                    <button class="btn-actualizar-foto" title="Actualizar foto del almacén">
                                ...
                                <td>
                                    <div class="acciones-simples">
                                        <button class="btn-accion-ubicacion ver" 
                                                ...
                                                onclick="window.location.href='{{ route('ubicaciones.estante.detalle', ['id' => $producto['estante_id']]) }}'">
...
<div id="modalEditarEstante" class="modal-overlay hidden">
    <div class="modal-container">
        ...
        <form id="formEditarEstante" class="modal-content" novalidate>
            ...
            <div class="form-group">
                <label for="editar_tipo_estante">Tipo de Estante</label>
                <div class="input-group">
                    <iconify-icon icon="solar:widget-5-bold-duotone"></iconify-icon>
                    <select id="editar_tipo_estante" name="tipo" required>
                        <option value="">Seleccionar tipo...</option>
                        <option value="venta">Estante de Venta</option>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="form-group">
                    ...
                    <small class="form-help">Los niveles no se pueden modificar después de crear el estante</small>
                </div>
                <div class="form-group">
                    ...
                    <small class="form-help">Las columnas no se pueden modificar después de crear el estante</small>
                </div>
            </div>
            
            <!-- Capacidad total calculada (solo lectura) -->
            <div class="form-group">
                <label>Capacidad Total (Calculada automáticamente)</label>
                <div class="capacidad-calculada-display">
                    <div class="capacidad-info readonly">
                        <iconify-icon icon="solar:calculator-bold-duotone"></iconify-icon>
