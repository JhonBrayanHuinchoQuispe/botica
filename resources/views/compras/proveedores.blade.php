            ...
            <div class="proveedores-table-header-improved">
                <div class="proveedores-filters-layout-improved">
                    ...
                    <div class="proveedores-filters-right">
                        <button type="button" class="proveedores-btn-nueva-entrada-visible" onclick="abrirModalAgregar()">
            ...
            <div class="proveedores-table-wrapper-improved">
                ...
                <table class="proveedores-table" id="tablaProveedores">
                    ...
                    <tbody>
                        ...
                        <tr class="proveedores-data-row {{ $proveedor->estado !== 'activo' ? 'opacity-75' : '' }}">
                            <td>
                            ...
                            <td>
                                @if($proveedor->estado === 'activo')
                                    <span class="proveedores-badge proveedores-badge-success">
                                        <iconify-icon icon="solar:check-circle-bold-duotone"></iconify-icon>
                                        Activo
                                    </span>
                                @else
                                    <span class="proveedores-badge proveedores-badge-secondary">
                                ...
                                <div class="proveedores-action-buttons">
                                    ...
                                    @if($proveedor->estado === 'activo')
                                        <button class="proveedores-action-btn proveedores-action-btn-delete" 
                                                onclick="cambiarEstado({{ $proveedor->id }}, 'inactivo')" 
                                                title="Desactivar">
                                            <iconify-icon icon="solar:close-circle-bold-duotone"></iconify-icon>
                                        </button>
                                    @else
                                        <button class="proveedores-action-btn proveedores-action-btn-success" 
                                                onclick="cambiarEstado({{ $proveedor->id }}, 'activo')" 
                                                title="Activar">
                                            <iconify-icon icon="solar:check-circle-bold-duotone"></iconify-icon>
                                        </button>
                                    @endif
                            ...
                            <td colspan="7">
                                <div class="proveedores-empty-improved">
                                    ...
                                    <div class="proveedores-empty-actions">
                                        <button type="button" class="proveedores-btn-primary-small" onclick="abrirModalAgregar()">
                                            <iconify-icon icon="solar:add-circle-bold-duotone"></iconify-icon>
