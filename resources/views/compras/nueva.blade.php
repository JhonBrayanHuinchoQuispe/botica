        ...
        <div class="compras-grid-simple">
            ...
            <div class="compras-field-group">
                ...
                <div class="select-wrapper">
                    <select name="proveedor_id" class="compras-input-simple compras-select-simple">
            ...
            <!-- Fila 3: Información del Lote -->
            <div class="compras-field-group">
                <label class="compras-label-simple">
                    <iconify-icon icon="solar:code-bold-duotone"></iconify-icon>
                    Número de Lote *
                </label>
                <input type="text" name="lote" class="compras-input-simple" placeholder="Ej: LOTE-2025-001" required>
                <span class="compras-hint-simple">Ingresa el número de lote de la mercadería</span>
            </div>
            ...
            <div class="compras-field-group">
                ...
                <input type="date" name="fecha_vencimiento" class="compras-input-simple">
                <span class="compras-hint-simple">Opcional: Fecha de vencimiento del lote</span>
            </div>
...
<script src="{{ asset('assets/js/compras/nueva-compra.js') }}"></script>
