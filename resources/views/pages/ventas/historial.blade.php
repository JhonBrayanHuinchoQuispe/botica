                ...
                <table class="historial-table" id="tablaHistorial">
                    ...
                    <tbody>
                        @forelse($ventas as $venta)
                            ...
                            <td>
                                @if($venta->cliente)
                                    <div class="historial-provider-name">{{ $venta->cliente->nombre_completo }}</div>
                                    <div class="historial-provider-commercial">DNI: {{ $venta->cliente->dni }}</div>
                                @else
                                    <span class="historial-badge historial-badge-gray">Sin cliente</span>
                                @endif
                            </td>
                            <td>
