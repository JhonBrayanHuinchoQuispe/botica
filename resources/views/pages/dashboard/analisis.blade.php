...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/css/inventario/tablas.css', 'resources/js/app.js'])
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/dashboard/analisis.css') }}">
        ...
        <!-- ⚡ DATOS DINÁMICOS PARA EL SCRIPT EXTERNO -->
    <script>
        // 🚀 Datos del servidor para el dashboard
        window.chartData = {
        ...
        // 🚀 Datos adicionales para nuevas funcionalidades
...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 4xl:grid-cols-5 gap-6">
        ...
        <div class="card shadow-none border border-gray-200 dark:border-gray-600 rounded-lg h-full bg-gradient-to-r from-purple-600/10 to-bg-white dark:from-purple-600/20 dark:to-gray-800">
            <div class="card-body h-full p-5">
                <div class="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        <p class="font-medium text-neutral-900 dark:text-white mb-1">Inventario Total</p>
                        <h6 class="mb-0 dark:text-white">{{ number_format($totalProductos) }}</h6>
                    </div>
                ...
                <p class="font-medium text-sm text-neutral-600 dark:text-gray-300 mt-3 mb-0 flex items-center gap-2">
                    @if($cambioStock < 0)
                        <span class="inline-flex items-center gap-1 text-danger-600 dark:text-red-400">
                            <iconify-icon icon="bxs:down-arrow" class="text-xs"></iconify-icon> 
                            {{ $cambioStock }}
                        </span>
                    @else
                        <span class="inline-flex items-center gap-1 text-success-600 dark:text-green-400">
        ...
        <div class="card shadow-none border border-gray-200 dark:border-gray-600 rounded-lg h-full bg-gradient-to-r from-blue-600/10 to-bg-white dark:from-blue-600/20 dark:to-gray-800">
            <div class="card-body p-5">
                <div class="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        <p class="font-medium text-neutral-900 dark:text-white mb-1">Ventas</p>
                        <h6 class="mb-0 dark:text-white">{{ number_format($ventasMes) }}</h6>
                    </div>
                ...
                <p class="font-medium text-sm text-neutral-600 dark:text-gray-300 mt-3 mb-0 flex items-center gap-2 cambio-ventas">
        ...
        <div class="card shadow-none border border-gray-200 dark:border-gray-600 rounded-lg h-full bg-gradient-to-r from-success-600/10 to-bg-white dark:from-success-600/20 dark:to-gray-800">
            <div class="card-body p-5">
                <div class="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        <p class="font-medium text-neutral-900 dark:text-white mb-1">Ingresos</p>
                        <h6 class="mb-0 dark:text-white">S/. {{ number_format($ingresosMes, 2) }}</h6>
                    </div>
        ...
        <div class="card shadow-none border border-gray-200 dark:border-gray-600 rounded-lg h-full bg-gradient-to-r from-red-600/10 to-bg-white dark:from-red-600/20 dark:to-gray-800">
            <div class="card-body p-5">
                <div class="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        <p class="font-medium text-neutral-900 dark:text-white mb-1">Rendimiento</p>
                        <h6 class="mb-0 dark:text-white">S/. {{ number_format($rendimiento, 2) }}</h6>
                    </div>
