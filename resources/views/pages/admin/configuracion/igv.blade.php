                    ...
                    <form id="formConfiguracionIgv" onsubmit="guardarConfiguracionIgv(event)">
                        ...
                        <div class="space-y-8 max-w-6xl">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                <div class="form-group-modern">
                                    <label class="form-label-modern">
                                        <iconify-icon icon="solar:money-bag-bold-duotone" class="text-lg mr-2"></iconify-icon>
                                        Incluir IGV en Precios
                                    </label>
                                    <select name="incluir_igv_precios" id="incluir_igv_precios" class="form-control-modern">
                                        <option value="1" {{ $configuracion->incluir_igv_precios ? 'selected' : '' }}>Sí, precios incluyen IGV</option>
                                        <option value="0" {{ !$configuracion->incluir_igv_precios ? 'selected' : '' }}>No, precios sin IGV</option>
                                    </select>
                                    <div class="form-help-text">
                                        <iconify-icon icon="solar:price-tag-linear"></iconify-icon>
                                        Define si los precios de productos ya incluyen IGV
                                    </div>
                                </div>
                            </div>

                            <!-- Tercera fila: Mostrar en tickets -->
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                <div class="form-group-modern">
                                    <label class="form-label-modern">
