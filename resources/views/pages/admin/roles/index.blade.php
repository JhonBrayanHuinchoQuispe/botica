...
@php
    ...
    $script='
        ...
        <script src="' . asset('assets/js/admin/roles.js') . '?v=20250102001"></script>
    ';
@endphp
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/admin/roles.css') }}?v=20250102001">
...
<div class="filter-section bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-4">
    <div class="flex flex-wrap items-center gap-4 justify-between">
        ...
        <div class="flex items-center gap-2">
            <button type="button" 
                    class="btn-action-elegant btn-info" 
                    ...
                    <div class="grid-campos columnas-2">
                        <div class="campo-grupo">
                            <label class="campo-label">
                                <iconify-icon icon="solar:code-bold-duotone" class="label-icon" style="color: #3b82f6;"></iconify-icon>
                                Nombre del Sistema *
                            </label>
                            <input type="text" name="name" id="name" class="campo-input" placeholder="ej: admin, vendedor" required>
                            <div style="font-size: 12px; color: #64748b; margin-top: 4px;">Solo letras minúsculas, números y guiones</div>
                        </div>
                    ...
                    <div class="modulos-permisos">
                        ...
                        <div class="modulo-permiso-card">
                            ...
                            <div class="modulo-header">
                                <div class="checkbox-modulo-container">
                                    <input type="checkbox" 
                                           id="module_{{ $modulo }}" 
                                           class="checkbox-modulo module-checkbox" 
                                           data-module="{{ $modulo }}"
                                           onchange="toggleModulePermissions('{{ $modulo }}')">
                                    <label for="module_{{ $modulo }}" class="modulo-label">
                                ...
                                <div class="permiso-card">
                                    ...
                                    <label for="permission_{{ $permiso->id }}" class="permiso-label">
                                        <div class="permiso-info">
                                            <div class="permiso-nombre">{{ $permiso->display_name }}</div>
                                            <div class="permiso-codigo">{{ $permiso->name }}</div>
                                            @if($permiso->description)
