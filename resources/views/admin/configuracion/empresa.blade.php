                    ...
                    <form id="formConfiguracionEmpresa" onsubmit="guardarConfiguracionEmpresa(event)">
                        ...
                        <div class="space-y-8 max-w-6xl">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" name="empresa_nombre" id="empresa_nombre" 
                                           ...
                                           placeholder="Ingrese el nombre completo de su empresa" required>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                <div class="form-group-modern">
                                    <label class="form-label-modern">
                                        <iconify-icon icon="solar:phone-bold-duotone" class="text-lg mr-2"></iconify-icon>
                                        Teléfono
                                    </label>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="logo-upload-area" style="padding: 1.5rem; min-height: 120px;">
                                    <div class="flex flex-col items-center justify-center h-full">
                                        <iconify-icon icon="solar:cloud-upload-bold-duotone" class="text-3xl text-gray-400 mb-2"></iconify-icon>
                                ...
                                <div class="logo-preview-container" style="min-height: 120px;">
                        ...
                        <div class="flex justify-end gap-3 mt-8 pt-4 border-t border-gray-200">
                            <a href="{{ route('admin.configuracion') }}" class="btn btn-secondary-modern">
                    ...
                    <div class="data-item">
                        <div class="flex items-center gap-2">
                            <div class="p-2 bg-purple-100 rounded-full">
                                <iconify-icon icon="solar:phone-bold" class="text-purple-600"></iconify-icon>
                            </div>
                            <span class="data-label">Teléfono:</span>
                        </div>
                        <span class="data-value {{ $configuracion->empresa_telefono ? '' : 'text-red-500 italic' }}">{{ $configuracion->empresa_telefono ?? 'No configurado' }}</span>
                    </div>
                    <div class="data-item">
                        <div class="flex items-center gap-2">
