...
@php
    ...
    $script='
        ...
        <script src="' . asset('assets/js/admin/usuarios.js') . '?v=20250102013"></script>
    ';
@endphp
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/admin/usuarios.css') }}?v=20250102011">
    <link rel="stylesheet" href="{{ asset('assets/css/admin/roles.css') }}?v=20250102007">
...
<div class="filter-section bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-4">
    <div class="flex flex-wrap items-center gap-4 justify-between">
        <!-- Búsqueda Elegante -->
        <div class="search-container-modern flex-1 min-w-[320px]">
            <div class="relative">
                <input type="text" 
                       id="searchInput" 
    ...
    <div class="table-responsive">
        <table class="users-table" id="usersTable">
            ...
            <tbody>
                ...
                <tr data-user-id="{{ $usuario->id }}" class="user-row">
                    <!-- Usuario -->
                    <td>
                        <div class="user-cell">
                    ...
                    <td>
                        <div class="action-buttons">
                            ...
                            @php
                                $isGerente = $usuario->roles->contains('name', 'Gerente');
                            @endphp
                            ...
                            @if(!$isGerente)
                                ...
                                <!-- Estado -->
                                <button type="button" 
                                        class="action-btn {{ $usuario->is_active ? 'btn-deactivate' : 'btn-activate' }}" 
                                        onclick="toggleUserStatus({{ $usuario->id }})"
                                        title="{{ $usuario->is_active ? 'Desactivar' : 'Activar' }} Usuario">
                                    <iconify-icon icon="{{ $usuario->is_active ? 'heroicons:pause' : 'heroicons:play' }}"></iconify-icon>
                                </button>
                            ...
                            @else
                                ...
                                <button type="button" 
                                        class="action-btn btn-protected" 
                                        title="Usuario Protegido - No se puede cambiar estado">
                ...
                <div class="seccion-form seccion-azul">
                    <div class="seccion-header">
                        ...
                        <div class="seccion-titulo">
                            ...
                            <p>Sube una imagen para el avatar del usuario</p>
                        </div>
                    </div>
                    ...
                    <div class="avatar-upload-modern">
                        ...
                        <div class="avatar-controls-modern">
                            ...
                            <div class="avatar-info">
                                <span class="avatar-formats">Formatos: JPG, PNG, GIF (Max: 2MB)</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid-campos columnas-2">
                        <div class="campo-grupo">
                            <label class="campo-label">
                                <iconify-icon icon="solar:user-bold-duotone" class="label-icon" style="color: #10b981;"></iconify-icon>
                                Nombres *
                            </label>
                        ...
                        <div class="campo-grupo">
                            <label class="campo-label">
                                <iconify-icon icon="solar:phone-bold-duotone" class="label-icon" style="color: #10b981;"></iconify-icon>
                                Teléfono
                            </label>
                        ...
                        <div class="campo-grupo">
                            <label class="campo-label">
                                <iconify-icon icon="solar:case-bold-duotone" class="label-icon" style="color: #10b981;"></iconify-icon>
                                Cargo
                            </label>
                            <input type="text" name="cargo" id="cargo" class="campo-input" placeholder="Cargo en la empresa">
                        </div>
                        
                        <div class="campo-grupo campo-completo">
                            <label class="campo-label">
                                <iconify-icon icon="solar:map-point-bold-duotone" class="label-icon" style="color: #10b981;"></iconify-icon>
                                Dirección
                            </label>
                ...
                <div class="seccion-form seccion-amarillo">
                    <div class="seccion-header">
                        ...
                        <div class="seccion-titulo">
                            ...
                            <p>Email y contraseña para el sistema</p>
                        </div>
                    </div>
                    ...
                    <div class="grid-campos columnas-2">
                        <div class="campo-grupo campo-completo">
                            <label class="campo-label">
                                <iconify-icon icon="solar:letter-bold-duotone" class="label-icon" style="color: #f59e0b;"></iconify-icon>
                                Correo Electrónico *
                            </label>
                        ...
                        <div class="campo-grupo">
                            <label class="campo-label">
                                <iconify-icon icon="solar:key-bold-duotone" class="label-icon" style="color: #f59e0b;"></iconify-icon>
                                Contraseña <span id="passwordRequired" style="color: #ef4444;">*</span>
                            </label>
                            <div class="password-wrapper">
                                <input type="password" name="password" id="password" class="campo-input con-icono" placeholder="Mínimo 8 caracteres" style="padding-right: 48px;">
                                <iconify-icon icon="solar:key-bold-duotone" class="campo-icon"></iconify-icon>
                            ...
                            <div class="password-strength">
                                ...
                                <span id="password-strength-text" class="strength-text">Muy débil</span>
                            </div>
                        </div>
                        
                        <div class="campo-grupo">
                            <label class="campo-label">
                                <iconify-icon icon="solar:lock-keyhole-bold-duotone" class="label-icon" style="color: #f59e0b;"></iconify-icon>
                                Confirmar Contraseña <span id="confirmPasswordRequired" style="color: #ef4444;">*</span>
                            </label>
                            <div class="password-wrapper">
                                <input type="password" name="password_confirmation" id="password_confirmation" class="campo-input con-icono" placeholder="Repita la contraseña" style="padding-right: 48px;">
                                <iconify-icon icon="solar:lock-keyhole-bold-duotone" class="campo-icon"></iconify-icon>
                        ...
                        <div class="campo-grupo campo-completo">
                            <div style="background: #fef3c7; border: 1px solid #fde68a; border-radius: 6px; padding: 10px; margin-top: 8px; font-size: 13px;">
                                ...
                                <span style="color: #b45309;"> Mín. 8 caracteres, mayúscula, minúscula y número</span>
                            </div>
                        </div>
                    </div>
                </div>
