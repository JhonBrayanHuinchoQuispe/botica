    ...
    <div class="pos-main">
        ...
        <div class="pos-left-panel">
            ...
            <div class="pos-search-section">
                <div class="pos-search-container">
                    ...
                    <div class="pos-filters-buttons">
                        ...
                        <button class="pos-filter-btn" data-filtro="alternativas" onclick="cambiarFiltro('alternativas', this)">
                            <iconify-icon icon="solar:pills-bold-duotone"></iconify-icon>
                            <span>Alternativas</span>
                            <span class="filter-counter" id="contadorAlternativas">0</span>
                        </button>
                    </div>
                </div>
            ...
            <div class="pos-productos-section">
                ...
                <div id="productosAlternativos" class="pos-alternativas" style="display: none;">
                    <div class="pos-alternativas-header">
                        <iconify-icon icon="solar:lightbulb-bold-duotone"></iconify-icon>
                        <span>Productos alternativos recomendados</span>
                    </div>
                    <div id="alternativasGrid" class="pos-alternativas-grid">
                        <!-- Alternativas aquí -->
                    </div>
                </div>
            </div>
        ...
        <div class="pos-right-panel">
            <div class="pos-resumen-container">
                ...
                <div class="pos-resumen-compacto">
                    ...
                    <!-- COMPROBANTE SIMPLE -->
                    <div class="pos-comprobante-simple">
                        <label class="pos-comprobante-toggle">
                            <input type="checkbox" id="conComprobante">
                            <span class="pos-comprobante-slider"></span>
                            <span class="pos-comprobante-label">Con comprobante</span>
                        </label>
                    </div>

                    <!-- BOTÓN PROCESAR -->
                    <div class="pos-accion-principal">
                        <button id="btnProcesarVenta" 
                                class="pos-btn-procesar-farmacia" 
