...
<body>
    <button class="print-button no-print" onclick="window.print()">🖨️ Imprimir Boleta A4</button>
    ...
    <div class="boleta-container">
        ...
        <div class="header">
            ...
            <div class="boleta-info">
                ...
                <div class="boleta-number">{{ $venta->numero_venta }}</div>
        ...
        <!-- Se elimina sección QR y datos bancarios por solicitud -->
